   ...
   public class ROPermeateBL
    {
        ...
        #region RO Permeate Status Log Report
        /// <summary>

        /// </summary>
        public ApplicationResult ROPermeateReport(DateTime FromDatetime, DateTime ToDatetime)
        {
            try
            {
                ...
                strStoredProcName = "usp_rpt_ROPermeate_Report";
