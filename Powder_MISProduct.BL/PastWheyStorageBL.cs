...
{
   public class PastWheyStorageBL
    {
        ...
        #region Pastwhey Storage Status Log Report
        /// <summary>

        /// </summary>
        public ApplicationResult PastwheyStorage(DateTime FromDatetime, DateTime ToDatetime)
        {
            try
            {
                ...
                strStoredProcName = "usp_rpt_PastwheyStorage_Report";
