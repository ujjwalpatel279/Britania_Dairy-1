...
namespace Powder_MISProduct.BL
{
    public class RWSTStorageBL
    {
        ...
        /// </summary>
        public ApplicationResult RWSTStorageReport(DateTime FromDatetime, DateTime ToDatetime)
        {
            try
            {
                ...
                strStoredProcName = "usp_rpt_RWSTStorage_Report";
